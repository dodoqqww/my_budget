...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  Orientation _getOrientation(BuildContext context) {
    Orientation result = MediaQuery.of(
      context,
    )?.orientation;
    if (result == null) {
...
//                  DropdownMenuItem(child: Text('Samsung')),
//                  DropdownMenuItem(child: Text('Sony')),
//                  DropdownMenuItem(child: Text('LG')),
//                ], //simple function that holds the values of all the items
